...
Page({
  ...
  data: {
    ...
    yj_list:[
      ...
      { name: "东圃店纸巾机", time: "2018-07-17", price: "78" },
      { name: "东圃店纸巾机", time: "2018-06-16", price: "78" },
      { name: "东圃店纸巾机", time: "2018-05-15", price: "78" },
      { name: "东圃店纸巾机", time: "2018-04-14", price: "78" },
      { name: "东圃店纸巾机", time: "2018-03-13", price: "78" }
    ]
    // daijin: true,
    // dj_list:[
